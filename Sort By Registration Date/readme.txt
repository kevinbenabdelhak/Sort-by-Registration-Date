...
### Sort by Registration Date Un outil indispensable pour la gestion d'utilisateurs

"Sort by Registration Date" simplifie l'administration des utilisateurs en ajoutant une nouvelle colonne intitulée "Date d'inscription" dans votre tableau de gestion des utilisateurs dans WordPress.
...
1. **Téléchargez le fichier ZIP du plugin :**
   Rendez-vous sur la page de "Sort by Registration Date" sur WordPress.org et téléchargez le fichier ZIP du plugin.
